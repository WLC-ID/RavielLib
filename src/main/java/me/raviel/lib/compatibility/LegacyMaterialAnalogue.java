package me.raviel.lib.compatibility;
...
public enum LegacyMaterialAnalogue {
    ...
    ANCIENT_DEBRIS(ServerVersion.V1_15, "STONE"),
    ...
    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String legacyMaterial, byte legacyData) {
        this(versionLessThan, null, legacyMaterial, legacyData, null, null, null);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String legacyMaterial) {
        this(versionLessThan, null, legacyMaterial, null, null, null, null);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String modernAnalouge, String legacyMaterial) {
        this(versionLessThan, modernAnalouge, legacyMaterial, null, null, null, null);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String modernAnalouge, String legacyMaterial, byte legacyData) {
        this(versionLessThan, modernAnalouge, legacyMaterial, legacyData, null, null, null);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String legacyMaterial, byte legacyData, ServerVersion legacyMinimum, String compatMaterial, byte compatData) {
        this(versionLessThan, null, legacyMaterial, legacyData, legacyMinimum, compatMaterial, compatData);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String legacyMaterial, ServerVersion legacyMinimum, String compatMaterial, byte compatData) {
        this(versionLessThan, null, legacyMaterial, null, legacyMinimum, compatMaterial, compatData);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String legacyMaterial, byte legacyData, ServerVersion legacyMinimum, String compatMaterial) {
        this(versionLessThan, null, legacyMaterial, legacyData, legacyMinimum, compatMaterial, null);
    }

    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String legacyMaterial, ServerVersion legacyMinimum, String compatMaterial) {
     ...
     */
    private LegacyMaterialAnalogue(ServerVersion versionLessThan, String modernAnalouge, String legacyMaterial, Byte legacyData, ServerVersion legacyMinimum, String compatMaterial, Byte compatData) {
