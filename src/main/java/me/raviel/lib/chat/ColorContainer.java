...
public class ColorContainer {
    ...
    public ColorCode getColor() {
        ...
        try {
            jColor = new Color(Integer.valueOf(hexCode.substring(0, 2), 16),
                    Integer.valueOf(hexCode.substring(2, 4), 16), Integer.valueOf(hexCode.substring(4, 6), 16));
        } catch (NumberFormatException ex) {
            try {
                jColor = new Color(Integer.valueOf(hexCode.substring(1, 3), 16),
